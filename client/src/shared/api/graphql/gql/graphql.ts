...
export type InviteWorkspaceMemberMutation = { __typename: 'Mutation', inviteWorkspaceMember: { __typename: 'WorkspaceInvitationType', id: string, email: string | null, status: InvitationStatus } };
